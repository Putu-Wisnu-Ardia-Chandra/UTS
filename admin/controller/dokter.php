            ...
            if(!isset($err)){
                ...
                if(!empty($_POST['id_dokter'])){
                    ...
                    if(isset($_POST['photo'])){
                        ...
                        id_spesialisasi='$_POST[id_spesialisasi]', photo='$_POST[photo]' where id_dokter='$_POST[id_dokter]'";
                    }else{
                        $sql="update dokter set nama_dokter='$_POST[nama_dokter]',no_id='$_POST[no_id]', nip='$_POST[nip]',id_pendidikan='$_POST[id_pendidikan]',
                    ...
                    //save
                    if(isset($_POST['photo'])){
                        $sql = "INSERT INTO dokter (nama_dokter, no_id, nip,id_pendidikan,id_spesialisasi,photo) 
