<h4>Tambah Berita</h4>
<hr>
<form action="index.php?mod=berita&page=save" method="POST" class="ajax">
  ...
  <div class="form-group">
    ...
    <textarea rows="5" name="isi" id="isi" class="form-control" required><?= (isset($_POST['isi'])) ? $_POST['isi'] : ''; ?></textarea>
  </div>
